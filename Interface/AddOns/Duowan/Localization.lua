...
if (GetLocale() == "zhCN") then	
	...
	DUOWAN_CHANGELOG_FONT = "Fonts\\ARHei.TTF";
	...
	DUOWAN_ON_DATA_STRING = "欢迎使用|CFF00B4FF微会免费电话|r，每月赠送400分钟话费，国内手机随意呼。登录魔盒还可领取专属话费红包哦。|CFF00B4FF|HWoWBoxShare:|h[分享]|h|r";	
	DUOWAN_BLIZZARD_REPORT = "欢迎使用微会免费电话，每月赠送400分钟话费，国内手机随意呼。登录魔盒还可领取专属话费红包哦。";
	L["Close"] = "关 闭";
	...
	DUOWAN_PALADIN_POWERBAR = "多玩圣能条";
	ECLIPSEBARFRAME_MENU_TITLE_TEXT = "蚀能助手";
	ECLIPSEBARFRAME_MENU_SCALE_TEXT = "缩放尺寸";
	ECLIPSEBARFRAME_TOOLTIP_TEXT = "蚀能助手";
	ECLIPSEBARFRAME_MOVE_TIP_TEXT = "Shift+左键移动位置\nShift+右键恢复定位";
	DUOWAN_TEAMNOTICE_HEAD = "魔盒团队提示: ";
	DUOWAN_TEAMNOTICE_TEXT = "海内存知己，魔盒最懂你！欢迎加入我们的团队！";
	DUOWAN_TEAMNOTICE_ADD_TEXT = "请输入要发送的团队公告信息";
	DUOWAN_QUESTINFO_DIALOG_TEXT = "确认开启任务指引<QuestHelperLite>\n";
	DUOWAN_QUESTINFO_TEXT = "任务指引";
	DUOWAN_QUESTINFO_LOAD_TEXT = "载入任务指引";
	DUOWAN_SIMPLE_MODE_TEXT = "简洁模式";
	DUOWAN_CHONGJI_HUODONG = "多玩魔盒达人冲级大赛";
	DUOWAN_TALENTED_TITLE = "天赋模拟器";
	DUOWAN_WOWBOX_NOTICE = "魔盒提示";
	DUOWAN_WOWBOX_HUANHUA = "将想要幻化成装备放入相应的装备栏中。";
	DUOWAN_WOWBOX_RELOADUI = "重载插件";
	DUOWAN_WOWBOX_RELOADUI_TIPS = "无法取消|cff71d5ff[天赋]|r或|cff71d5ff[雕文]|r时使用";
elseif (GetLocale() == "zhTW") then	
	...
	DUOWAN_PALADIN_POWERBAR = "多玩聖能條";
	ECLIPSEBARFRAME_MENU_TITLE_TEXT = "蝕能助手";
	ECLIPSEBARFRAME_MENU_SCALE_TEXT = "縮放尺寸";
	ECLIPSEBARFRAME_TOOLTIP_TEXT = "蝕能助手";
	ECLIPSEBARFRAME_MOVE_TIP_TEXT = "Shift+左鍵移動位置\nShift+右鍵恢復定位";
	DUOWAN_TEAMNOTICE_HEAD = "魔盒團隊提示: ";
	DUOWAN_TEAMNOTICE_TEXT = "海內存知己，魔盒最懂你！歡迎加入我們的團隊！";
	DUOWAN_TEAMNOTICE_ADD_TEXT = "請輸入要發送的團隊公告資訊";
	DUOWAN_QUESTINFO_DIALOG_TEXT = "確認開啟任務指引<QuestHelperLite>\n";
	DUOWAN_QUESTINFO_TEXT = "任務指引";
	DUOWAN_QUESTINFO_LOAD_TEXT = "載入任務指引";
	DUOWAN_SIMPLE_MODE_TEXT = "簡潔模式";
	DUOWAN_CHONGJI_HUODONG = "多玩魔盒达人冲级大赛";
	DUOWAN_TALENTED_TITLE = "天赋模拟器";
	DUOWAN_WOWBOX_NOTICE = "魔盒提示";
	DUOWAN_WOWBOX_HUANHUA = "將想要幻化成裝備放入相應的裝備欄中。";
	DUOWAN_WOWBOX_RELOADUI = "重載插件";
	DUOWAN_WOWBOX_RELOADUI_TIPS = "無法取消|cff71d5ff[天賦]|r或|cff71d5ff[雕文]|r時使用";
else	
	...
	DUOWAN_WOWBOX_HUANHUA = "将想要幻化成装备放入相应的装备栏中。";
	DUOWAN_WOWBOX_RELOADUI = "重载插件";
	DUOWAN_WOWBOX_RELOADUI_TIPS = "无法取消|cff0099CC[天赋]|r或|cff0099CC[雕文]|r时使用";
end
