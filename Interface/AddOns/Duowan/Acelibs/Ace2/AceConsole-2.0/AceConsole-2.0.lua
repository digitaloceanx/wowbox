...
local function confirmPopup(message, func, ...)
	if not dwStaticPopupDialogs["ACECONSOLE20_CONFIRM_DIALOG"] then
		dwStaticPopupDialogs["ACECONSOLE20_CONFIRM_DIALOG"] = {}
	end
	local t = dwStaticPopupDialogs["ACECONSOLE20_CONFIRM_DIALOG"]
	for k in pairs(t) do
		t[k] = nil
	end
	t.text = message
	...
	dwStaticPopup_Show("ACECONSOLE20_CONFIRM_DIALOG")
end
