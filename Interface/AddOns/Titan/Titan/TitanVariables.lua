...
local Default_Plugins = {
	{id = "Coords", loc = "Bar"},
	{id = "XP", loc = "Bar"},
	{id = "GoldTracker", loc = "Bar"},
	{id = "Clock", loc = "Bar"},
	{id = "Volume", loc = "Bar"},
	{id = "AutoHide_Bar", loc = "Bar"},
	{id = "Bag", loc = "Bar"},
	{id = "AuxAutoHide", loc = "AuxBar"},
	{id = "Repair", loc = "Bar"},
	{id = "Mail", loc = "Bar"},
	{id = "Track", loc = "Bar"},
	{id = "WinterTimer", loc = "Bar"},
	{id = "TolBarad", loc = "Bar"},
}
--[[ Titan
...
TitanSkinsDefaultPath = "Interface\\AddOns\\Titan\\Titan\\Artwork\\"
...
-------------------
-- dugu@wowbox
function TitanPanelShowCustomButton(var, value)
	local plugin = TitanUtils_GetPlugin(var);
	if (not plugin) then return end

	if (value) then
		TitanUtils_AddButtonOnBar("Bar", var);		
		TitanSetVar(var, "DisplayOnRightSide", 1);
	else
		TitanPanel_RemoveButton(var);
	end

	TitanSetVar(var, "ShowLabelText", false);
	TitanPanelButton_UpdateButton(var);
end