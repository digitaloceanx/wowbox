...
L["Lock the Objective Tracker in place"] = "锁定任务追踪框位置" -- Needs review
L["You can unlock it again in the options"] = "您可以在设置中再次解锁" -- Needs review
...
L["Reset the position of the Objective Tracker to the default."] = "重置任务追踪框为默认位置。" 
L["Unlock Quest Tracker position"] = "解锁任务追踪框位置";
L["Unlock the position of the Objective Tracker, allowing it to be moved by clicking and dragging its header."] = "解锁任务追踪框的位置，使其能够通过拖拉标题而移动。" -- Needs review
L["Always show objective percentage values on progress bars"] = "总是在进度条中显示任务百分比值."
L["Toggling this option may require a UI reload to fully take effect."] = "开关此选项，需要重载插件。";
L["Always show objective percentage values on progress bars"] = "始终显示目标进度条的百分比" -- Needs review
end
