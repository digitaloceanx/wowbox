...
elseif (GetLocale() == "zhCN") then
	symbol_1K, symbol_10K, symbol_1B = "Ç§", "Íò", "ÒÚ"
elseif (GetLocale() == "zhTW") then
	symbol_1K, symbol_10K, symbol_1B = "Çª", "Èf", "ƒ|"
end
...
function WorldQuestTracker.UpdateTrackerScale()
	...
	--WorldQuestTrackerFrame_QuestHolder:SetScale (WorldQuestTracker.db.profile.tracker_scale) --aumenta s?as quests sem mexer no cabeçalho
end
