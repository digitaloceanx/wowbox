...
L["S_MAPBAR_SORTORDER_TIMELEFTPRIORITY"] = "剩餘時間優先"
...
L["S_PARTY_DESC2"] = "如果顯示紅色星星，表示某個隊伍成員沒有世界任務，或尚未安裝 WQT。"
