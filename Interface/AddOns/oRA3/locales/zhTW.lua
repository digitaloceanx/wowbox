...
L["activatedRing"] = "%s 使用 %s (%s)"
L["add"] = "增加"
L["align"] = "對齊"
L["allSpells"] = "所有選擇的法術"
L["announce"] = "通告"
L["announceDesc"] = "當戒指使用時發送訊息到團隊頻道。"
...
L["clear"] = "清除"
L["clickable"] = "可點擊的"
L["clickableDesc"] = "啟用點擊讓您可以點擊圖示使用戒指。"
...
L["onlyMyRing"] = "只有我的戒指"
L["onlyMyRingDesc"] = "只有當您的戒指類型使用時撥放音效。"
L["onlyRaids"] = "只在團隊中顯示。"
L["onlyRaidsDesc"] = "只有你在團隊中才顯示監視器。"
L["options"] = "設定"
L["orientation"] = "方向"
L["outline"] = "輪廓"
L["outOfRange"] = "超出距離玩家"
...
L["showText"] = "顯示文字"
L["showTextDesc"] = "顯示最後一個使用戒指玩家的戒指類型或名稱。"
L["showWindow"] = "顯示視窗"
