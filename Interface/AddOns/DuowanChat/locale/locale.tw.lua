...
L["ChatFrame"]="聊天快捷欄"
L["IconFrame"]="聊天表情欄"
L["DWChat provides you convient tools like copy text, name highlight and timestamps"]="多玩聊天增強為妳提供復制聊天文字，高亮姓名以及聊天時間顯示等各種功能。"
L["Enable DWChat"]="使用多玩聊天增強"
...
L["BigFoot Channel has been blocked"] = "|cffffff00停止接收世界頻道和轉發頻道資訊。|r"
L["BigFoot Channel has been unblocked"] = "|cff00ff00繼續接收世界頻道和轉發頻道資訊。|r"

L["Channel mute label"] = "遮罩消息";
L["Channel mute desc"] = "遮罩世界頻道和轉發頻道，不\n再接此頻道的消息。";
...
L["Chat Channel"] = "聊天通道"
L["Low level filter message"] = "低於10級的玩家不能在世界頻道和轉發頻道發言";
...
L["JoinChannel2"] = "加入頻道"
L["LeaveChannel"] = "離開頻道"
L["OwnChannel"] = "頻道所有者已變更為"
L["PasswordChange"] = "密碼已被"
L["ModifyChannel"] = "獲得了修改許可權"
L["SayTooltip"] = "普通說話"
L["PartyTooltip"] = "小隊發言"
L["RaidTooltip"] = "團隊發言"
L["BGTooltip"] = "戰場發言"
...
if GetLocale()=="zhTW" then
	BINDING_HEADER_DWCTITLE="多玩聊天增強"
