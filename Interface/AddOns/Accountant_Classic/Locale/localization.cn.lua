-- $Id: localization.cn.lua 138 2016-06-19 18:28:32Z arith $ 
...
L["ACCLOC_CENT"] = "铜"
L["ACCLOC_CHAR"] = "角色"
L["ACCLOC_CHARREMOVEDONE"] = "「%s - %s」角色的 Accountant Classic 资料已经移除。"
...
L["ToC/Description"] = "|cff00CC33追踪每个角色的所有收入与支出状况，并可显示当日小计、当周小计、以及自有记录起的总计。并可显示所有角色的总金额。|r"
L["ToC/Title"] = "|cFF00FF00[信息]|rAccountant Classic"
