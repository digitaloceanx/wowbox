...
L["GladiatorlosSACredits"] = "Customizable PvP Announcer addon for vocalizing many important spells and cast by your enemies.|n|n|cffFFF569Created by|r |cff9482C9Abatorlos|r |cffFFF569of Spinebreaker|r|n|cffFFF569Legion update by|r |cffC79C6EOrunno|r |cffFFF569of Moon Guard (With permission from zuhligan)|r|n|n|cffFFF569Past Contributors|r|n|cffA330C9superk521|r (Past Project Manager)|n|cffA330C9DuskAshes|r (Chinese Support)|n|cffA330C9N30Ex|r (Mists of Pandaria Support)|n|cffA330C9zuhligan|r (Warlords of Draenor & French Support)|n|cffA330C9jungwan2|r (Korean Support)|n|cffA330C9Mini_Dragon|r (Chinese support after WoD)"
...
L["Also announce class name with trinket alert when hostile targets use PvP trinket in arena"] = "In arenas, announces the class that used their PvP Medallion, EMFH, or WotF. |n|n|cffC41F3BEnabling this will disable unique callouts for 'Every Man for Himself', 'Will of the Forsaken', and the new xMinutes Trinket callouts. 'Trinketed: Class' will be the callout for all of these abilities. This is a bug that I will fix in a future version.|r"
...
L["Big Heals"] = true
L["Greater Heal, Divine Light, Greater Healing Wave, Healing Touch, Enveloping Mist"] = "Heal (Priest)|nHoly Light (|cffF58CBAPaladin|r)|nHealing Wave (|cff0070daShaman|r)|nHealing Touch (|cffFF7D0ADruid|r)"
L["Resurrection"] = true
...
L["EnemyInterrupts"] = "Enemy Interrupts NYI"
